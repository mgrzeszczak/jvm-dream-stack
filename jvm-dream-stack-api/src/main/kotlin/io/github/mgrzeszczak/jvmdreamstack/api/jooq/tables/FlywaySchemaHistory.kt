...
import io.github.mgrzeszczak.jvmdreamstack.api.jooq.indexes.FLYWAY_SCHEMA_HISTORY_S_IDX
import io.github.mgrzeszczak.jvmdreamstack.api.jooq.keys.FLYWAY_SCHEMA_HISTORY_PK
...
open class FlywaySchemaHistory(
     ...
     */
    val CHECKSUM: TableField<FlywaySchemaHistoryRecord, Int?> =
     ...
     */
    val INSTALLED_ON: TableField<FlywaySchemaHistoryRecord, LocalDateTime?> = createField(
    ...
    private constructor(alias: Name, aliased: Table<FlywaySchemaHistoryRecord>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<FlywaySchemaHistoryRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<FlywaySchemaHistoryRecord>?, where: Condition?) : this(
        alias,
        null,
        null,
        null,
     ...
     */
    @PlainSQL
    override fun where(condition: SQL): FlywaySchemaHistory = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String): FlywaySchemaHistory = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg binds: Any?): FlywaySchemaHistory =
     ...
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): FlywaySchemaHistory =
